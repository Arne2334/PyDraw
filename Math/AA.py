...
#     ax.scatter(pos[0], pos[1], pos[2], c='green', marker='*', s=200, label=name)
#     ax.text(pos[0], pos[1], pos[2], name, color='green')
...
def plot_cylinder(ax, center, radius, height, resolution=100, color='gray', alpha=0.5):
    ...
    在3D图中绘制圆柱体
    :param ax: 3D轴对象
    :param center: 圆柱体底部中心坐标 (x, y, z)
    :param radius: 圆柱体半径
    :param height: 圆柱体高度
    :param resolution: 圆柱体的分辨率（越高越平滑）
    :param color: 圆柱体颜色
    :param alpha: 透明度
    """
    # 生成圆柱体的参数
